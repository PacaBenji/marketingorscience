...
window.MOS_ARTICLES = [
  {
    ...
    deck         : 'Early peanut introduction prevents allergy, and the first drug treatments are now FDA-approved. A review of the LEAP trials, oral immunotherapy, and what the NEJM clinical guidance actually supports.',
    category     : 'Pharma & OTC',
    categorySlug : 'pharma',
    ...
    searchText   : 'peanut allergy prevention treatment leap trial leap-on leap-trio early introduction oral immunotherapy oit ar101 palforzia omalizumab xolair outmatch niaid guidelines food allergy anaphylaxis pediatrics nejm clinical practice pharma treatment analysis',
    popular      : false,
    readingTime  : 10,
